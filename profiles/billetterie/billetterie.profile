...
/**
 * @file
 * Enables modules and site configuration for the DDO ticket office proto site installation.
 */
...
function system_form_install_select_profile_form_alter(&$form, $form_state) {
   foreach($form['profile'] as $key => $element) {
     $form['profile'][$key]['#value'] = 'billetterie';
   }
}
...
function rouergue_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['site_information']['site_name']['#default_value'] = 'Proto billetterie';
